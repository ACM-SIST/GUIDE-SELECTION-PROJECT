...
def mail1(request):
    if request.method == 'POST':
        ...
        send_mail('RANDOM OTP', 'The OTP is: '+ mail1.user_otp1,EMAIL_HOST_USER,[mail1.user_email, ],fail_silently=False,)
        send_mail('RANDOM OTP', 'The OTP is: '+ mail1.user_otp2,EMAIL_HOST_USER,[mail1.user_email1, ],fail_silently=False,)
